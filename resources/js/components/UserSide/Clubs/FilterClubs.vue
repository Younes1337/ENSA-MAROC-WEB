...
export default {
    data() {
        ...
        return {
            ...
            contracts: ['Arts', 'Business', 'Sports', 'Education', 'General Interest', 'Health Professions', 'Language and Culture', 'History, Law and Politics', 'Publications and Media', 'Service and Social Justice', 'Student Governance', 'Wellness', 'Other'],
        };
        // const defaultForm = Object.freeze({
        //     modal: false,
        //     date: '',
